...
class VisualisationMonitoring:
    ...
    def show_points_for_one_node_v(self, node_name, color='green'):
        """
        ...
        :return:
        """
        list_coord=self.DB.return_all_coord_for_a_node_r(node_name)
        coord_of_node=self.DB.return_own_coord_of_node_r(node_name)
        #self.DB.close()
    ...
    def show_all_points_in_db_v(self):
        """
        in plot
        ...
        all_x=[]
        all_y=[]
        all_nodes_names=self.DB.all_nodes_names_r()
