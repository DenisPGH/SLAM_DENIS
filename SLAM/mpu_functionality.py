...
class MPU:
    def __init__(self):
        ...
        self.mpu_yaw_divider_factor = 2940 # old one
        self.mpu_yaw_divider_factor_left=5100 # 2940 ,8900     dies shoud be changed to lower/higher
        
        self.mpu_yaw_divider_factor_right=5230 # 2940 ,3600,5230=11.3V
        self.real_yaw_angle_degrees=0

        self.HIGH_NEUTRAL_RANGE=180 # 80
        self.LOW_NEUTRAL_RANGE=-120 # -80
        ###########################
